        ...
        <div key={index}>
          ...
          {item.id === 1 ? (
            ...
            <Link href="/on-demand" passHref>
              <h3 className="py-2">{item.subtitle}</h3>
            </Link>
          ) : item.id === 2 ? (
            ...
            <Link href="/elevate-membership" passHref>
              <h3 className="py-2">{item.subtitle2}</h3>
            </Link>
          ) : (
            ...
            <>
              ...
              {item.subtitle3 && (
                ...
                <Link href="/about" passHref>
                  <h3 className="py-2">{item.subtitle3}</h3>
                </Link>
              )}
              ...
              {item.subtitle4 && (
                ...
                <Link href="/solutions" passHref>
                  <h3 className="py-2">{item.subtitle4}</h3>
                </Link>
              )}
              ...
              {item.subtitle5 && (
                ...
                <Link href="/news" passHref>
                  <h3 className="py-2">{item.subtitle5}</h3>
                </Link>
              )}
              ...
              {item.subtitle6 && (
                ...
                <Link href="/contact" passHref>
                  <h3 className="py-2">{item.subtitle6}</h3>
                </Link>
              )}
            </>
          )}
