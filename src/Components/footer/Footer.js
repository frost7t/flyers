...
export default function Footer() {
  return (
    <div className="bg-[#000d10]">
      <div className="mx-auto lg:max-w-[1740px] max-w-[90%]">
        <Link href="/">
          <div className="pt-[4vw] mb-[5.1vw]">
            <svg
              viewBox="0 0 116 45"
              fill="none"
        ...
        <div className="lg:flex gap-10 ">
          <div className="w-1/4">
            <h1 className="text-[#ffff] text-3xl font-bold">Follow Us</h1>
            <SocialFooter />
          </div>
          <div className="w-1/2">
            <FooterLink />
        ...
        <div className="pt-20">
          <FooterBottom
            title="© Hyer Aviation 2023"
            subtitle=" Hyer® HQ - Eindhoven, The Netherlands Registered on the Dutch
            Chamber of Commerce: 80195520"
            link1="Cookie policy"
            link2="Terms & Conditions"
            link3="Privacy Policy"
            description="Hyer® is a charter broker with a global digital platform and is not
            a direct air carrier. All flights advertised to which Hyer® has
            access are owned and operated by a properly licensed third party air
            carrier, compliant with rules outlined by the European Union
            Aviation Safety Agency (or other appropriate authority under foreign
            law). Hyer® does not carry additional liability insurance.
            Passengers are covered by the aircraft operator insurance."
          />
        </div>
      </div>
    </div>
