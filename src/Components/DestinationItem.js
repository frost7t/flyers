...
export default function DestinationItem({
  ...
  const borderClass = Border ? "border-t-[1px] border-gray-300" : ""; // Si Border est vrai, défini la classe CSS "border-t-[1px] border-gray-300", sinon, une chaîne de caractères vide
  ...
  return (
    ...
    >
      <h3 className="text-4xl font-semibold pb-40">
